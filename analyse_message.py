...
CLINICAL_NORMALIZATION_MAP = {
    ...
    "clou": "chirurgie",
    "broche": "chirurgie",
    "lca": "ligament croise genou chirurgie",
    ...
    "coiffe des rotateurs": "coiffe epaule chirurgie",
...
def _extraire_indices_cached(message):
    ...
    mots_chirurgie_oui = [
        ...
        "vis", "plaque", "clou", "broche", "osteosynthese", "ostéosynthèse"
    ]
    mots_chirurgie_non = [
